...
public class EnemySO : ScriptableObject
{
    ...
    public float DodgeRange; //range that attacks will be detected and dodge attempted
    public float DodgeCooldown; //range that attacks will be detected and dodge attempted
